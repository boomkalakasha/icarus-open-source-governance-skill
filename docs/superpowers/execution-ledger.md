...
| P1 | GitHub PR/settings/releases | Terra controller | BLOCKED | authenticated GitHub evidence | Existing AI/Icarus remotes are configured, but Governance has no remote; no authenticated GitHub browser method is available. No push, PR, ruleset, merge, tag, release, or profile mutation was attempted. |
