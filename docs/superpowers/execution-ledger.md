...
| P1 | GitHub PR/settings/releases | Terra controller | BLOCKED | authenticated GitHub evidence | 2026-08-25: AI feature branch `7cddf9be65f62f0891c8e60d6b5cb3bdaca137d1` and Icarus feature branch `edb50b178f12f2d80a7bc4e5efa0764c94fbdbd4` were pushed to their respective `origin` remotes. PR, CI, merge, tag, and release were not executed. Governance has no `origin` or other remote; new-repository creation and GitHub settings remain blocked pending an authenticated GitHub method. |
